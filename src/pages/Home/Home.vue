    ...
    <Page>
      ...
      <div class="item-block row">
        <a href="/lifehacks/" class="home-banner-link">
          <img class="lifehacks-banner" :src="`${path}/livefuck.png`">
        </a>
        <a href="/top/" class="home-banner-link">
          <img class="lifehacks-banner" :src="`${path}/top-20.png`">
        </a>
      </div>
      ...
      <div class="row">
        <div class="home-item" v-for="item in page" :key="item.title">
          <div class="text">
            <h5 :class="item.new ? `ael razum-h5-background` : `ael razum-h5`" v-html="item.title"></h5>

            <div class="inner-home-item">
              <div>
                <div class="item-img">
                  <img :src="`${path}${item.img}`" alt="" title="">
                </div>
